...
for (const [content, token, label] of [
  ...
  [workLog, "OWNER_CONFIRMED_GITHUB_ACTIONS_DEPLOY_SUCCEEDED_FOR_COMMIT_919d3df", "work log A-16BT owner deploy marker"],
  [workLog, "A16BT_DEPLOY_EVIDENCE_STATUS=PASS_OWNER_CONFIRMED_GITHUB_ACTIONS_DEPLOY_SUCCEEDED", "work log A-16BT deploy evidence"],
  ...
  [decisionLog, "Decision 324 - A-16BT deploy evidence accepted from owner marker", "decision A-16BT deploy evidence"],
  ...
  [handoff, "OWNER_CONFIRMED_GITHUB_ACTIONS_DEPLOY_SUCCEEDED_FOR_COMMIT_919d3df", "handoff A-16BT owner deploy marker"],
