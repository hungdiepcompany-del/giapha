...
for (const [content, token, label] of [
  ...
  [workLog, "A17N_TX2F_STATUS=PASS_STATIC_CORRECTION_DB_EXECUTION_SAFE_SKIP", "work log A17N-TX2F"],
  [decisionLog, "Decision 335 - A-17N-TX2F corrects post-apply verifier active graph scope", "decision A17N-TX2F"],
  [handoff, "A17N_TX2F_STATUS=PASS_STATIC_CORRECTION_DB_EXECUTION_SAFE_SKIP", "handoff A17N-TX2F"],
]) {
