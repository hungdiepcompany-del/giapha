...
for (const [content, token, label] of [
  ...
  [service, "ok: boolean", "service ok can vary after A-16AE"],
  [service, "const canRunOfficialImport = reasons.length === 0", "service canRun gate"],
  [service, "status: \"BLOCKED\"", "service blocked status"],
  [service, "\"A16V_OWNER_VERIFIED_RUNTIME_STILL_DISABLED\"", "service disabled transaction status"],
