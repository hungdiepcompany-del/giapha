...
for (const [content, token, label] of [
  ...
  [workLog, "A17O_STATUS=BLOCKED_IMPORT_TRANSACTION_EXECUTOR_GROUPED_FAMILY_SUPPORT_REQUIRED", "work log A-17O"],
  [
    decisionLog,
    "Decision 339 - A-17O keeps importer grouping dormant until grouped transaction executor exists",
    "decision A-17O",
  ],
  [handoff, "A17O_STATUS=BLOCKED_IMPORT_TRANSACTION_EXECUTOR_GROUPED_FAMILY_SUPPORT_REQUIRED", "handoff A-17O"],
]) {
