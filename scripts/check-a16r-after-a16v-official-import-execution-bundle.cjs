...
for (const [content, token, label] of [
  ...
  [decisionLog, "A-16R after A-16V stops at production deploy evidence gate", "decision log bundle decision"],
  [handoff, "A16R_AFTER_A16V_BUNDLE_STATUS=BLOCKED_PRODUCTION_DEPLOY_EVIDENCE_MISSING", "handoff bundle status"],
]) {
...
for (const [content, token, label] of [
  ...
  [service, "A16V_BLOCKED_REAL_TRANSACTION_BRANCH_NOT_APPLIED_OR_VERIFIED", "A-16V runtime blocker remains explicit"],
