...
```text
DEPLOY_STATUS=RECORDED_IN_FINAL_PHASE_REPORT_AFTER_PUSHED_COMMIT_DEPLOY
PRODUCTION_PAGE_SMOKE=RECORDED_IN_FINAL_PHASE_REPORT_AFTER_DEPLOY
PRODUCTION_API_SMOKE=RECORDED_IN_FINAL_PHASE_REPORT_AFTER_DEPLOY
```

## Next action

```text
NEXT_ACTION=DEPLOY_PUSHED_CLOSEOUT_COMMIT_AND_RUN_FOCUSED_PRODUCTION_SMOKE
```
