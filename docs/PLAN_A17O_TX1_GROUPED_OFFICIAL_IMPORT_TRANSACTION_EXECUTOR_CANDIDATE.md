...
- `A17O_RUNTIME_SOURCE_INTEGRATION=PASS_A17O_R_SOURCE_ONLY_NO_IMPORT_EXECUTED`
...
- `A17O_R_GROUPED_IMPORTER_RUNTIME_SOURCE_INTEGRATED=YES`
- `NEXT_ACTION=OWNER_REVIEW_A17O_R_THEN_SEPARATE_PUSH_DEPLOY_AND_PRODUCTION_NO_IMPORT_MUTATION_SMOKE`

A-17O-R connects future official-import runtime source to the grouped executor
adapter. It does not alter this migration, does not call the grouped executor,
does not execute SQL, and does not deploy.
