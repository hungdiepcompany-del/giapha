...
- `DB_MIGRATION_SHA256=9ABDF7EDC4BEAD60316A82098C72A21BB01464510F7AD3604E4D5FAB83490C66`
...
## FIX3 Final Integrity Contract

FIX3 corrects the four remaining owner-review blockers without applying
migration 0026 and without creating migration 0027:
...
- `PRODUCTION_QUERIED=YES_SELECT_ONLY_VERIFIER_BY_OWNER`
- `RPC_CALLED=NO`
...
## A-17Q-TX1R Manual Apply Verification

Owner-provided production evidence records that migration 0026 was manually
applied to project `frkyeuxrlcflmsxxsolp` and the SELECT-only verifier passed
without calling the reconciliation executor:
