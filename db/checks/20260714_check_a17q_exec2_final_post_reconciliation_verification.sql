...
select
  ...
  (select people_before_hash <> '' and people_after_hash <> '' and people_before_hash = people_after_hash from hash_integrity) as people_rows_unchanged_pass,
  (select layout_before_hash <> '' and layout_after_hash <> '' and layout_before_hash = layout_after_hash from hash_integrity) as layout_rows_unchanged_pass,
  (select excluded_before_hash <> '' and excluded_after_hash <> '' and excluded_before_hash = excluded_after_hash from hash_integrity) as excluded_hash_unchanged_pass,
  (select deleted_before_hash <> '' and deleted_after_hash <> '' and deleted_before_hash = deleted_after_hash from hash_integrity) as deleted_hash_unchanged_pass,
