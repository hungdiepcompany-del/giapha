...
-- Replaces only public.execute_admin_a17q_legacy_family_reconciliation so
-- pgcrypto digest resolution does not depend on the fixed RPC search_path.
-- Migration 0026 is already applied; this patch preserves the reviewed
-- signature, SECURITY INVOKER mode, search_path, grants, hashes and manifests.
